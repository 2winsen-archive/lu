...
<head>
	...
	<title>Main menu: add group</title>
...
<div id="page">
	<div id="content">
		<div class="post">
			<h2 class="title"><fmt:message key="sidebar.new.group">Create new skill group</fmt:message></h2>
			<div class="entry">
				...
				<c:if test="${result == '1'}">
					<p class="confirm"><fmt:message key="group.sucess">New group added successfully.</fmt:message></p>
					<p><span style="color: red;"><fmt:message key="group.create.another">Create another group? </fmt:message></span>
						<a href="action.do?_flowId=group-add-flow"><fmt:message key="general.yes">Yes.</fmt:message></a>
						<span> / </span>
