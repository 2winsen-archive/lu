...
<div id="page">
	<div id="content">
		<div class="post">
			<h2 class="title"><fmt:message key="contact.title">Contact</fmt:message></h2>
			<div class="entry">
			<h3>
				<fmt:message key="contact.text">Here soon will be contact information.</fmt:message>
			</h3>
			</div>
		</div>
	</div>
