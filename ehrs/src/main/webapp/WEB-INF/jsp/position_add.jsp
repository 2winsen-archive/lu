...
<head>
	...
	<title>Main menu: add position</title>
...
<div id="page">
	<div id="content">
		<div class="post">
			<h2 class="title"><fmt:message key="sidebar.new.position">Create new position</fmt:message></h2>
			<div class="entry">
				<form:form commandName="position" method="POST">
				<p>
					<form:errors cssClass="error" />
				</p>
				<c:if test="${result == '1'}">
					<p class="confirm"><fmt:message key="position.sucess">New position added successfully.</fmt:message></p>
					<p><span style="color: red;"><fmt:message key="position.create.another">Create another position? </fmt:message></span>
						<a href="action.do?_flowId=position-add-flow"><fmt:message key="general.yes">Yes.</fmt:message></a>
						<span> / </span>
