...
<head>
	...
	<title>Main menu: view offices</title>
...
<div id="page">
	<div id="content">
		<div class="post">
			<h2 class="title"><fmt:message key="sidebar.view.office">View offices</fmt:message></h2>
			<div class="entry">
				<form:form commandName="office" method="POST">
				<fieldset >
				<legend style="font-weight: bold;"><fmt:message key="office.view.criteria">View offices criteria</fmt:message></legend>
				<table>
					<tr>
						<td><fmt:message key="office.view.name">Name:</fmt:message></td>
			...
			<c:if test="${offices != null}">
				<div class="results">
					<table>
						<tr class="header">
							<th><fmt:message key="office.result.name">Name</fmt:message></th>
						...
						<c:forEach var="office" items="${offices}">
							<tr>
								<td>${office.name}</td>
								<td>
									<a href="action.do?_flowExecutionKey=${flowExecutionKey}&_eventId=select&id=${office.id}">
