...
<head>
	...
	<title>Main menu: change group</title>
...
<div id="page">
	<div id="content">
		<div class="post">
			<h2 class="title"><fmt:message key="general.change">Change</fmt:message> ${group.name}</h2>
			<div class="entry">
				...
				<form name="group" method="POST">
					...
					<c:if test="${result == '1'}">
						<p class="confirm"><fmt:message key="group.change.sucess">Group information changed successfully.</fmt:message></p>
						<p><span style="color: red;"><fmt:message key="group.change.return">Return to this group? </fmt:message></span>
					...
					<c:if test="${result != 1}">			
					<fieldset>
					<legend style="font-weight: bold;"><fmt:message key="group.info">Group information</fmt:message></legend>
					<table>
						<tr>
							<td><fmt:message key="group.name">Name*:</fmt:message></td>
							<td><input type="text" name='<c:out value="name" />' value='<c:out value="${group.name}" />' /></td>
						</tr>
						<tr>
							<td><fmt:message key="group.comments">Comments:</fmt:message></td>
							<td>
					...
					<input type="hidden" name='<c:out value="id" />' value='<c:out value="${group.id}" />' />
