...
<div id="page">
	<div id="content">
		<div class="post">
			<h2 class="title">${group.name} <fmt:message key="general.information">information</fmt:message></h2>
			<div class="entry">
				<table class="actions">
					<tr>
					...
					<tr>
						<c:if test="${deleteSignal == 0}">
							<td colspan="2" style="color: red;">
								<fmt:message key="group.cannot.delete">Cannot delete this group, must be DB constraint problem.</fmt:message>									
							</td>
						</c:if>
					</tr>
					</c:if>
				...
				<table>
					...
					<tr>
						...
						<td class="info" >${group.comments}</td>
					</tr>
					<tr>
						<td><fmt:message key="general.timestamp">Timestamp</fmt:message></td>
						<td class="info" >${group.timestamp}</td>
					</tr>					
				</table>
			</div>
		</div>
