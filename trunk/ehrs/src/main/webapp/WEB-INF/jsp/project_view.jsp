...
<head>
	...
	<title>Main menu: view projects</title>
...
<div id="page">
	<div id="content">
		<div class="post">
			<h2 class="title"><fmt:message key="sidebar.view.project">View projects</fmt:message></h2>
			<div class="entry">
				<form:form commandName="project" method="POST">
				<fieldset >
				<legend style="font-weight: bold;"><fmt:message key="project.view.criteria">View projects criteria</fmt:message></legend>
				<table>
					<tr>
						<td><fmt:message key="project.view.name">Name:</fmt:message></td>
						<td><form:input path="name"/></td>
					</tr>
					<tr>
						<td><fmt:message key="project.view.manager.surname">Manager surname:</fmt:message></td>
						<td><form:input path="managerSurname"/></td>
					</tr>
				</table>
				</fieldset>
				<br/>
			...
			<c:if test="${projects != null}">
				<div class="results">
					<table>
						<tr class="header">
							<th><fmt:message key="project.result.name">Name</fmt:message></th>
						...
						<c:forEach var="project" items="${projects}">
							<tr>
								<td>${project.name}</td>
								<td>
									<a href="action.do?_flowExecutionKey=${flowExecutionKey}&_eventId=select&id=${project.id}">
