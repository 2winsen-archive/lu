...
<head>
	...
	<title>Main menu: add project</title>
...
<div id="page">
	<div id="content">
		<div class="post">
			<h2 class="title"><fmt:message key="sidebar.new.project">Create new project</fmt:message></h2>
			<div class="entry">
				...
				<c:if test="${result == '1'}">
					<p class="confirm"><fmt:message key="project.sucess">New project added successfully.</fmt:message></p>
					<p><span style="color: red;"><fmt:message key="project.create.another">Create another project? </fmt:message></span>
						<a href="action.do?_flowId=project-add-flow"><fmt:message key="general.yes">Yes.</fmt:message></a>
						<span> / </span>
