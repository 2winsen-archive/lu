...
<head>
	...
	<title>Main menu: position info</title>
...
<div id="page">
	<div id="content">
		<div class="post">
			<h2 class="title">${position.name} <fmt:message key="general.information">information</fmt:message></h2>
			<div class="entry">
				<table class="actions">
					<tr>
					...
					<tr>
						<c:if test="${deleteSignal == 0}">
							<td colspan="2" style="color: red;">
								<fmt:message key="position.cannot.delete">Cannot delete this position, must be DB constraint problem.</fmt:message>									
							</td>
						</c:if>
					</tr>
					</c:if>
				...
				<table>
					...
					<tr>
						...
						<td class="info" >${position.comments}</td>
					</tr>
					<tr>
						<td><fmt:message key="general.timestamp">Timestamp</fmt:message></td>
						<td class="info" >${position.timestamp}</td>
					</tr>					
				</table>
			</div>
		</div>
