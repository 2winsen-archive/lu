...
<head>
	...
	<title>Main menu: view positions</title>
...
<div id="page">
	<div id="content">
		<div class="post">
			<h2 class="title"><fmt:message key="sidebar.view.position">View positions</fmt:message></h2>
			<div class="entry">
				<form:form commandName="position" method="POST">
				<fieldset >
				<legend style="font-weight: bold;"><fmt:message key="position.view.criteria">View positions criteria</fmt:message></legend>
				<table>
					<tr>
						<td><fmt:message key="position.view.name">Name:</fmt:message></td>
			...
			<c:if test="${positions != null}">
				<div class="results">
					<table>
						<tr class="header">
							<th><fmt:message key="position.result.name">Name</fmt:message></th>
						...
						<c:forEach var="position" items="${positions}">
							<tr>
								<td>${position.name}</td>
								<td>
									<a href="action.do?_flowExecutionKey=${flowExecutionKey}&_eventId=select&id=${position.id}">
