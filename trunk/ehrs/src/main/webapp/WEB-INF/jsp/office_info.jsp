...
<head>
	...
	<title>Main menu: group info</title>
...
<div id="page">
	<div id="content">
		<div class="post">
			<h2 class="title">${office.name} <fmt:message key="general.information">information</fmt:message></h2>
			<div class="entry">
				<table class="actions">
					<tr>
					...
					<tr>
						<c:if test="${deleteSignal == 0}">
							<td colspan="2" style="color: red;">
								<fmt:message key="office.cannot.delete">Cannot delete this office, must be DB constraint problem.</fmt:message>									
							</td>
						</c:if>
					</tr>
					</c:if>
				...
				<table>
					<tr>
						...
						<td class="info" >${office.id}</td>
					</tr>
					<tr>
						<td><fmt:message key="office.info.name">Name</fmt:message></td>
						<td class="info" >${office.name}</td>
					</tr>
					<tr>
						<td><fmt:message key="office.info.country">Country</fmt:message></td>
						<td class="info" >${country.name}</td>
					</tr>
					<tr>
						<td><fmt:message key="office.info.city">City</fmt:message></td>
						<td class="info" >${office.city}</td>
					</tr>
					<tr>
						<td><fmt:message key="office.info.zip">Zip</fmt:message></td>
						<td class="info" >${office.zip}</td>
					</tr>
					<tr>
						<td><fmt:message key="office.info.address">Address</fmt:message></td>
						<td class="info" >${office.address}</td>
					</tr>																				
					<tr>
						<td><fmt:message key="general.comments">Comments</fmt:message></td>
						<td class="info" >${office.comments}</td>
					</tr>
					<tr>
						<td><fmt:message key="general.timestamp">Timestamp</fmt:message></td>
						<td class="info" >${office.timestamp}</td>
					</tr>					
				</table>
			</div>
		</div>
