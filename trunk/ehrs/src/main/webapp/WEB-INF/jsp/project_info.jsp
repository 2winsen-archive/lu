...
<head>
	...
	<title>Main menu: project info</title>
...
<div id="page">
	<div id="content">
		<div class="post">
			<h2 class="title">${project.name} <fmt:message key="general.information">information</fmt:message></h2>
			<div class="entry">
				<table class="actions">
					<tr>
					...
					<tr>
						<c:if test="${deleteSignal == 0}">
							<td colspan="2" style="color: red;">
								<fmt:message key="project.cannot.delete">Cannot delete this project, must be DB constraint problem.</fmt:message>									
							</td>
						</c:if>
					</tr>
					</c:if>
				...
				<table>
					...
					<tr>
						<td><fmt:message key="project.info.manager.name">Manager name</fmt:message></td>
						<td class="info" >${project.managerName}</td>
					</tr>
					<tr>
						<td><fmt:message key="project.info.manager.surname">Manager surname</fmt:message></td>
						<td class="info" >${project.managerSurname}</td>
					</tr>					
					<tr>
						<td><fmt:message key="general.comments">Comments</fmt:message></td>
						<td class="info" >${project.comments}</td>
					</tr>
					<tr>
						<td><fmt:message key="general.timestamp">Timestamp</fmt:message></td>
						<td class="info" >${project.timestamp}</td>
					</tr>					
				</table>
			</div>
		</div>
