...
<div id="page">
	<div id="content">
		<div class="post">
			<h2 class="title"><fmt:message key="startup.welcome">Welcome to eHRS</fmt:message></h2>
			<div class="entry">
				<fmt:message key="startup.text">EHRS means electronic human resource system. Chose function in the left sidebar.</fmt:message>
			</div>
		</div>
	</div>
	<!-- end #content -->
