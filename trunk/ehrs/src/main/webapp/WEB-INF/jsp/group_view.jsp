...
<head>
	...
	<title>Main menu: view groups</title>
...
<div id="page">
	<div id="content">
		<div class="post">
			<h2 class="title"><fmt:message key="sidebar.view.group">View skills groups</fmt:message></h2>
			<div class="entry">
				<form:form commandName="group" method="POST">
				<fieldset >
				<legend style="font-weight: bold;"><fmt:message key="group.view.criteria">View groups criteria</fmt:message></legend>
				<table>
					<tr>
						<td><fmt:message key="group.view.name">Name:</fmt:message></td>
			...
			<c:if test="${groups != null}">
				<div class="results">
					<table>
						<tr class="header">
							<th><fmt:message key="group.result.name">Name</fmt:message></th>
						...
						<c:forEach var="group" items="${groups}">
							<tr>
								<td>${group.name}</td>
								<td>
									<a href="action.do?_flowExecutionKey=${flowExecutionKey}&_eventId=select&id=${group.id}">
